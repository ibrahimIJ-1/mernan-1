    ...
    >
      ...
      <div className="social">
        <div className="media" style={styles.style2}>
          <a style={styles.style2} href="https://linkedin.com">
            <FaLinkedin />
          </a>
          <a
            style={styles.style2}
          ...
          <a style={styles.style2} href="https://snapchat.com">
            <FaSnapchatGhost />
          </a>
          <a style={styles.style2} href="https://tiktok.com">
            <FaTiktok />
          </a>
          <a style={styles.style2} href="https://youtube.com">
            <FaYoutube />
          </a>
          <a style={styles.style2} href="https://twitter.com">
            <FaTwitter />
          </a>
          <a style={styles.style2} href="https://instegram.com">
            <AiFillInstagram />
          </a>
          <a style={styles.style2} href="https://behance.com">
            <FaBehance />
          </a>
        </div>
